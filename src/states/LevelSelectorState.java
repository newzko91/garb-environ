...
public class LevelSelectorState extends State{
	...
	private final int xOffset = (TelaPrincipal.WIDTH - DOUBLETILESIZE*6)/2;
	private final int yOffset = (TelaPrincipal.HEIGHT - DOUBLETILESIZE*5)/2;
	...
	public LevelSelectorState(TelaPrincipal telaPrincipal) {
		...
		back = new Button("BACK", TelaPrincipal.WIDTH/2, TelaPrincipal.HEIGHT - 100, new Click(){
